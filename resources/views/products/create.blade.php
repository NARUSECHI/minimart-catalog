...
<div class="container-lg mt-3">
    <div class="row">
        ...
        <div class="col-6 border border-1 p-0">
            <h3 class="text-white bg-success p-2">Add New Products</h3>
            <div class="row">
                <div class="col-1"></div>
                <div class="col-10">
                    <form action="{{ route('store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="section mt-1">
                            ...
                            <select name="section_id" id="section" class="form-select" value="{{old('section')}}">
                        ...
                        <div class="mt-4 mb-5">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <button type="submit" class="btn btn-success text-white" style="width:150px;">
